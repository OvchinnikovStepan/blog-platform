...
🔐 Аутентификация и Пользователи
 ...
 |DELETE |/api/articles/{slug} |Удаление статьи (мягкое) |✅|

💬 Комментарии

 |Метод |Эндпоинт |Описание|Аутентификация|
 |:-----|:--------|:-------|:--------------|
 |POST |/api/articles/{article_id}/comments |Добавление комментария к статье |✅|
 |GET |/api/articles/{article_id}/comments |Получение комментариев к статье |❌|
